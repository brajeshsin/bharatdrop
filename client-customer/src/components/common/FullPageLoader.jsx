...
const FullPageLoader = ({ message = 'INITIATING BHARATDROP...' }) => {
    return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-bg-base/80 dark:bg-slate-950/80 backdrop-blur-md">
            <div className="flex flex-col items-center gap-6 p-10 rounded-3xl bg-white/50 dark:bg-slate-900/50 border border-slate-200/20 dark:border-white/5 shadow-2xl">
                {/* Animated Rings */}
